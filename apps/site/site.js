(function () {
  ...
  const catalog = {
    ...
    'demo.reset': ['复位', 'Reset'],
    'demo.debug': ['调试', 'Debug'],
    'demo.environment': ['环境', 'Environment'],
    'demo.toggleEnvironment': ['大气与雾', 'Atmosphere and fog'],
    'demo.environment.close': ['关闭环境设置', 'Close environment settings'],
    'demo.atmosphere': ['大气', 'Atmosphere'],
    'demo.sun': ['太阳', 'Sun'],
    'demo.observeSun': ['观察太阳', 'Observe Sun'],
    'demo.observeSunTitle': ['切换到近地平线视角观察太阳', 'Move to a near-horizon view of the Sun'],
    'demo.fog': ['雾', 'Fog'],
    'demo.sunAzimuth': ['太阳方位', 'Sun azimuth'],
    'demo.sunZenith': ['太阳天顶角', 'Sun zenith'],
    'demo.turbidity': ['浑浊度', 'Turbidity'],
    'demo.exposure': ['曝光', 'Exposure'],
    'demo.fogDensity': ['雾强度', 'Fog density'],
    ...
    'demo.status.refining': ['细化中', 'Refining'],
    'demo.status.limited': ['精度受限', 'Quality limited'],
    ...
    'demo.debug.imageryLevels': ['影像层级', 'imagery levels'],
    'demo.debug.resolved': ['当前', 'resolved'],
    'demo.debug.transitionCoverage': ['过渡绘制', 'transition draws'],
    ...
    'demo.debug.environment': ['环境', 'environment'],
    'demo.debug.performance': ['性能', 'performance'],
    'demo.debug.full': ['完整更新', 'full'],
    'demo.debug.preview': ['相机预览', 'preview'],
    'demo.debug.render': ['渲染', 'render'],
    'demo.debug.wasmMemory': ['Wasm 内存', 'Wasm memory'],
    'demo.debug.phases': ['分段', 'phases'],
    'demo.debug.lod': ['LOD', 'LOD'],
    'demo.debug.read': ['读取', 'read'],
    'demo.debug.frameBuild': ['帧构建', 'frame build'],
    'demo.debug.rendererPhases': ['渲染器', 'renderer'],
    'demo.debug.geometryPrepare': ['几何准备', 'geometry'],
    'demo.debug.imageryRebuild': ['影像调度', 'imagery'],
    'demo.debug.on': ['开', 'on'],
    'demo.debug.off': ['关', 'off'],
