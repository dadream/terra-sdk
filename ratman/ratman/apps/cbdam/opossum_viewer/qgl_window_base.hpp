...
//======================================================================
//---HDR---//
#ifndef OPOSSUM_VIEWER_QGL_WINDOW_BASE_H
#define OPOSSUM_VIEWER_QGL_WINDOW_BASE_H
...
public:
  ...
  qgl_window_base( QWidget* parent, const char* name );
...
#endif // OPOSSUM_VIEWER_QGL_WINDOW_BASE_H
