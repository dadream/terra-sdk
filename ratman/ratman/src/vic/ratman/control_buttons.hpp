...
//======================================================================
//---HDR---//
#ifndef RATMAN_CONTROL_BUTTONS_HPP
#define RATMAN_CONTROL_BUTTONS_HPP
...
namespace ratman {
  ...
  class control_buttons: public active_renderable {
  protected:
    QImage gl_img_;
    GLuint gl_texid_;
    int icon_xc_;
    int icon_yc_;
    int icon_half_size_;
    int icon_quarter_size_;

  public:

    control_buttons( decorated_terrain_view* scene, const std::string& name );
 
    virtual ~control_buttons();
    ...
    inline int icon_quarter_size() const {
      return icon_quarter_size_;
    }
