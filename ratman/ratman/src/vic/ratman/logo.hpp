...
//======================================================================
//---HDR---//
#ifndef RATMAN_LOGO_HPP
#define RATMAN_LOGO_HPP
...
namespace ratman {
  ...
  class logo: public active_renderable {
  protected:
    QImage gl_img_;
    GLuint gl_texid_;
    int icon_xc_;
    int icon_yc_;
    int icon_half_size_w_;
    int icon_half_size_h_;
  public:

    logo(decorated_terrain_view* scene,
