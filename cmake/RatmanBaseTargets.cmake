option(TERRA_SDK_ENABLE_RATMAN_BASE_MATH
    "Build the first CMake target for ratman/base vic_math." ON)
option(TERRA_SDK_ENABLE_RATMAN_BASE_XML
    "Build the CMake target for ratman/base vic_xml." ON)
option(TERRA_SDK_ENABLE_RATMAN_BASE_IMG
    "Build the CMake target for ratman/base vic_img." ON)
option(TERRA_SDK_ENABLE_RATMAN_BASE_CURLSTREAM
    "Build the CMake target for ratman/base vic_curlstream." ON)
option(TERRA_SDK_ENABLE_RATMAN_BASE_FETCHER
    "Build the CMake target for ratman/base vic_fetcher." ON)
option(TERRA_SDK_ENABLE_RATMAN_BASE_QXML
    "Build the CMake target for ratman/base vic_qxml." ON)
option(TERRA_SDK_ENABLE_RATMAN_BASE_MPI
    "Build the CMake target for ratman/base vic_mpi." ON)
option(TERRA_SDK_ENABLE_RATMAN_BASE_GL
    "Build the CMake target for ratman/base vic_gl." ON)
option(TERRA_SDK_ENABLE_RATMAN_BASE_PERSISTENT
    "Build the CMake target for ratman/base vic_persistent." ON)

if(TERRA_SDK_ENABLE_RATMAN_BASE_MATH)
    if(NOT EXISTS "${TERRA_SDK_RATMAN_SOURCE_DIR}/base/src/vic/math/SS_amoeba.c")
        message(WARNING "vic_math source file not found; skipping vic_base_math")
    elseif(NOT TARGET terra_sdk_sl)
        ...
        message(STATUS "Configured CMake target vic_base_math -> libvic_math.a")
    endif()
endif()

if(TERRA_SDK_ENABLE_RATMAN_BASE_FETCHER)
    if(NOT EXISTS "${TERRA_SDK_RATMAN_SOURCE_DIR}/base/src/vic/fetcher/fetcher.cpp")
        message(WARNING "vic_fetcher source file not found; skipping vic_base_fetcher")
    elseif(NOT TARGET terra_sdk_sl)
    ...
    elseif(NOT TARGET terra_sdk_qt_core)
        ...
        message(STATUS "Configured CMake target vic_base_fetcher -> libvic_fetcher.a")
    endif()
endif()

if(TERRA_SDK_ENABLE_RATMAN_BASE_QXML)
    if(NOT EXISTS "${TERRA_SDK_RATMAN_SOURCE_DIR}/base/src/vic/qxml/database.cpp")
        message(WARNING "vic_qxml source file not found; skipping vic_base_qxml")
    elseif(NOT TARGET terra_sdk_qt_core)
    ...
    elseif(NOT TARGET terra_sdk_qt_xml)
        ...
        message(STATUS "Configured CMake target vic_base_qxml -> libvic_qxml.a")
    endif()
endif()

if(TERRA_SDK_ENABLE_RATMAN_BASE_MPI)
    if(NOT EXISTS "${TERRA_SDK_RATMAN_SOURCE_DIR}/base/src/vic/mpi/dummy.cpp")
        message(WARNING "vic_mpi source file not found; skipping vic_base_mpi")
    elseif(NOT TARGET terra_sdk_sl)
    ...
    elseif(NOT TARGET terra_sdk_mpi)
        ...
        message(STATUS "Configured CMake target vic_base_mpi -> libvic_mpi.a")
    endif()
endif()

if(TERRA_SDK_ENABLE_RATMAN_BASE_GL)
    if(NOT EXISTS "${TERRA_SDK_RATMAN_SOURCE_DIR}/base/src/vic/gl/font.cpp")
        message(WARNING "vic_gl source file not found; skipping vic_base_gl")
    elseif(NOT TARGET terra_sdk_opengl)
        ...
        message(STATUS "Configured CMake target vic_base_gl -> libvic_gl.a")
    endif()
endif()

if(TERRA_SDK_ENABLE_RATMAN_BASE_PERSISTENT)
    if(NOT EXISTS "${TERRA_SDK_RATMAN_SOURCE_DIR}/base/src/vic/persistent/map.hpp")
        message(WARNING "vic_persistent source file not found; skipping vic_base_persistent")
    elseif(NOT TARGET terra_sdk_sl)
    ...
    elseif(NOT TARGET terra_sdk_db4)
        ...
        message(STATUS "Configured CMake target vic_base_persistent -> libvic_persistent.a")
    endif()
endif()

if(TERRA_SDK_ENABLE_RATMAN_BASE_XML)
    if(NOT EXISTS "${TERRA_SDK_RATMAN_SOURCE_DIR}/base/src/vic/xml/tinyxml.cpp")
        message(WARNING "vic_xml source file not found; skipping vic_base_xml")
    else()
        ...
        message(STATUS "Configured CMake target vic_base_xml -> libvic_xml.a")
    endif()
endif()

if(TERRA_SDK_ENABLE_RATMAN_BASE_IMG)
    if(NOT EXISTS "${TERRA_SDK_RATMAN_SOURCE_DIR}/base/src/vic/img/gl_quadtree_image_processor.cpp")
        message(WARNING "vic_img source file not found; skipping vic_base_img")
    elseif(NOT TARGET terra_sdk_sl)
        ...
        message(STATUS "Configured CMake target vic_base_img -> libvic_img.a")
    endif()
endif()

if(TERRA_SDK_ENABLE_RATMAN_BASE_CURLSTREAM)
    if(NOT EXISTS "${TERRA_SDK_RATMAN_SOURCE_DIR}/base/src/vic/curlstream/curlstream.cpp")
        message(WARNING "vic_curlstream source file not found; skipping vic_base_curlstream")
    elseif(NOT TARGET terra_sdk_curl)
    ...
    elseif(NOT TARGET terra_sdk_zlib)
        ...
        message(STATUS "Configured CMake target vic_base_curlstream -> libvic_curlstream.a")
    endif()
endif()
