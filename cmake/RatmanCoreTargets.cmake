option(TERRA_SDK_ENABLE_RATMAN_CORE_VFS
    "Build the CMake target for ratman/src vic_vfs." ON)
option(TERRA_SDK_ENABLE_RATMAN_CORE_GEO_BASE
    "Build the CMake target for ratman/src vic_geo_base." ON)
option(TERRA_SDK_ENABLE_RATMAN_CORE_GEO_SRS
    "Build the CMake target for ratman/src vic_geo_srs." ON)
option(TERRA_SDK_ENABLE_RATMAN_CORE_GEO_BUILDER
    "Build the CMake target for ratman/src vic_geo_builder." ON)
option(TERRA_SDK_ENABLE_RATMAN_CORE_CBDAM_GEO
    "Build the CMake target for ratman/src vic_cbdam_geo." ON)
option(TERRA_SDK_ENABLE_RATMAN_CORE_CBDAM_BASE
    "Build the CMake target for ratman/src vic_cbdam_base." ON)
option(TERRA_SDK_ENABLE_RATMAN_CORE_RATMAN
    "Build the CMake target for ratman/src vic_ratman." ON)

set(_terra_sdk_ratman_public_include_dir "${TERRA_SDK_RATMAN_SOURCE_DIR}/ratman/src")

if(TERRA_SDK_ENABLE_RATMAN_CORE_VFS)
    if(NOT EXISTS "${TERRA_SDK_RATMAN_SOURCE_DIR}/ratman/src/vic/vfs/db_repository.cpp")
        message(WARNING "vic_vfs source file not found; skipping vic_core_vfs")
    ...
    elseif(NOT TARGET terra_sdk_qt_core)
        ...
        message(STATUS "Configured CMake target vic_core_vfs -> libvic_vfs.a")
    endif()
endif()

function(terra_sdk_configure_vic_core_cbdam_base)
    if(NOT EXISTS "${TERRA_SDK_RATMAN_SOURCE_DIR}/ratman/src/vic/cbdam/base/terrain_model.cpp")
        message(WARNING "vic_cbdam_base source file not found; skipping vic_core_cbdam_base")
    elseif(NOT TARGET terra_sdk_sl)
    ...
    elseif(NOT TARGET vic_core_cbdam_geo)
        ...
        message(STATUS "Configured CMake target vic_core_cbdam_base -> libvic_cbdam_base.a")
    endif()
endfunction()

if(TERRA_SDK_ENABLE_RATMAN_CORE_GEO_BUILDER)
    if(NOT EXISTS "${TERRA_SDK_RATMAN_SOURCE_DIR}/ratman/src/vic/geo/builder/geo_utility.cpp")
        message(WARNING "vic_geo_builder source file not found; skipping vic_core_geo_builder")
    elseif(NOT TARGET terra_sdk_sl)
    ...
    elseif(NOT TARGET vic_base_mpi)
        ...
        message(STATUS "Configured CMake target vic_core_geo_builder -> libvic_geo_builder.a")
    endif()
endif()

if(TERRA_SDK_ENABLE_RATMAN_CORE_CBDAM_GEO)
    if(NOT EXISTS "${TERRA_SDK_RATMAN_SOURCE_DIR}/ratman/src/vic/cbdam/geo/map_raster_sampler.cpp")
        message(WARNING "vic_cbdam_geo source file not found; skipping vic_core_cbdam_geo")
    elseif(NOT TARGET terra_sdk_sl)
    ...
    elseif(NOT TARGET terra_sdk_gdal)
        ...
        message(STATUS "Configured CMake target vic_core_cbdam_geo -> libvic_cbdam_geo.a")
    endif()
endif()

if(TERRA_SDK_ENABLE_RATMAN_CORE_GEO_BASE)
    if(NOT EXISTS "${TERRA_SDK_RATMAN_SOURCE_DIR}/ratman/src/vic/geo/base/tilemap_config.cpp")
        message(WARNING "vic_geo_base source file not found; skipping vic_core_geo_base")
    elseif(NOT TARGET terra_sdk_sl)
    ...
    elseif(NOT TARGET vic_base_xml)
        ...
        message(STATUS "Configured CMake target vic_core_geo_base -> libvic_geo_base.a")
    endif()
endif()

if(TERRA_SDK_ENABLE_RATMAN_CORE_GEO_SRS)
    if(NOT EXISTS "${TERRA_SDK_RATMAN_SOURCE_DIR}/ratman/src/vic/geo/srs/spatial_reference.cpp")
        message(WARNING "vic_geo_srs source file not found; skipping vic_core_geo_srs")
    elseif(NOT TARGET terra_sdk_sl)
    ...
    elseif(NOT TARGET terra_sdk_gdal)
        ...
        message(STATUS "Configured CMake target vic_core_geo_srs -> libvic_geo_srs.a")
    endif()
endif()
...
if(TERRA_SDK_ENABLE_RATMAN_CORE_RATMAN)
    if(NOT EXISTS "${TERRA_SDK_RATMAN_SOURCE_DIR}/ratman/src/vic/ratman/terrain_renderable.cpp")
        message(WARNING "vic_ratman source file not found; skipping vic_core_ratman")
    ...
    elseif(NOT TARGET terra_sdk_qt_printsupport)
        ...
        message(STATUS "Configured CMake target vic_core_ratman -> libvic_ratman.a")
    endif()
endif()
