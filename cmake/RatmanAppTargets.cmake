option(TERRA_SDK_ENABLE_RATMAN_APP_GEO_RASTER_QUADTREE_BUILDER
    "Build the additive CMake target for vic_geo_raster_quadtree_builder." ON)
option(TERRA_SDK_ENABLE_RATMAN_APP_CBDAM_MPI_BUILDER
    "Build the additive CMake target for vic_cbdam_mpi_builder." ON)
option(TERRA_SDK_ENABLE_RATMAN_APP_CBDAM_VIEWER
    "Build the additive CMake target for vic_cbdam_viewer." ON)
option(TERRA_SDK_ENABLE_RATMAN_APP_NAV3D
    "Build the additive CMake target for vic_ratman_nav3d." ON)

if(TERRA_SDK_ENABLE_RATMAN_APP_GEO_RASTER_QUADTREE_BUILDER)
    if(NOT EXISTS "${TERRA_SDK_RATMAN_SOURCE_DIR}/ratman/apps/geo/geo_raster_quadtree_builder/geo_raster_quadtree_builder.pro")
        message(WARNING "vic_geo_raster_quadtree_builder qmake project not found; skipping vic_app_geo_raster_quadtree_builder")
    ...
    elseif(NOT TARGET vic_core_geo_builder)
        ...
        message(STATUS "Configured additive CMake target vic_app_geo_raster_quadtree_builder -> vic_geo_raster_quadtree_builder")
    endif()
endif()

if(TERRA_SDK_ENABLE_RATMAN_APP_CBDAM_VIEWER)
    if(NOT EXISTS "${TERRA_SDK_RATMAN_SOURCE_DIR}/ratman/apps/cbdam/viewer/viewer.pro")
        message(WARNING "vic_cbdam_viewer qmake project not found; skipping vic_app_cbdam_viewer")
    ...
    elseif(NOT TARGET terra_sdk_glu)
        ...
        message(STATUS "Configured additive CMake target vic_app_cbdam_viewer -> vic_cbdam_viewer")
    endif()
endif()

if(TERRA_SDK_ENABLE_RATMAN_APP_CBDAM_MPI_BUILDER)
    if(NOT EXISTS "${TERRA_SDK_RATMAN_SOURCE_DIR}/ratman/apps/cbdam/mpi_builder/mpi_builder.pro")
        message(WARNING "vic_cbdam_mpi_builder qmake project not found; skipping vic_app_cbdam_mpi_builder")
    elseif(NOT TARGET vic_core_cbdam_base)
    ...
    elseif(NOT TARGET terra_sdk_shp)
        ...
        message(STATUS "Configured additive CMake target vic_app_cbdam_mpi_builder -> vic_cbdam_mpi_builder")
    endif()
endif()

if(TERRA_SDK_ENABLE_RATMAN_APP_NAV3D)
    if(NOT EXISTS "${TERRA_SDK_RATMAN_SOURCE_DIR}/ratman/apps/nav3d/nav3d.pro")
        message(WARNING "vic_ratman_nav3d qmake project not found; skipping vic_app_ratman_nav3d")
    ...
    elseif(NOT TARGET terra_sdk_glu)
        ...
        message(STATUS "Configured additive CMake target vic_app_ratman_nav3d -> vic_ratman_nav3d")
    endif()
endif()
