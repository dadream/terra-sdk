...
namespace sl {
  ...
  public: // Edge removal
    ...
    void erase_edge(const edge_t& e) {
      ...
      if (e_tri_ptr) {
        small_triangle_set_t e_tri = (*e_tri_ptr);
  ...
  public: // Vertex removal
    ...
    void erase_vertex(const vertex_t i0) {
      ...
      if (v_tri_ptr) {
        small_triangle_set_t v_tri = (*v_tri_ptr);
